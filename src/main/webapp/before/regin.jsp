...
.c {
			...
			<div class="updown" style="padding-bottom: 1px;">
				<div class="box_title">
					...
					<div class="right"
						...
						<a href="b_login.html" class="bluelink">登录</a> <span
 ...
 -->
				...
				<div style="padding-left: 363px; width: 252px; text-align: center;">
					<input type="checkbox"></input> <a id="btnAgree" class="bluelink"
						title="点击查看服务条款">《九江银行用户服务条款》</a>
				</div>
				<div id="dvAgree" class="agree" style="display: none;">
					<div
						style="font-size: 12px; color: #808080; font-family: &amp; quot; 宋体 &amp;quot; , Arial , Verdana; background-color: #FFFFFF;">
						<p style="margin: 0; line-height: 15px;">欢迎使用招商银行一网通用户服务。您在使用一网通用户服务时，即表示您接受下列条款和条件的约束（以下称“服务条款”），请认真阅读以下条款：</p>
						<p style="margin: 0; line-height: 15px;">1.客户要尊重网上道德，遵守《全国人大常委会关于维护互联网安全的决定》及中华人民共和国其他各项有关法律法规
							。</p>
				...
				<input id="hdSpAgree" type="hidden"
					value="../Content/cover/agreement.htm">
			</div>
